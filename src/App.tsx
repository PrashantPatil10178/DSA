      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        {sortedCodeExamples.map((example, index) => (
          <Card key={index} className="overflow-hidden">
            <CardHeader className="bg-secondary bg-[#f4f4f5]">
              <CardTitle className="font-light m-2">{example.title}</CardTitle>
              <Button className="bg-black rounded-lg text-white w-3/12">
                {example.description}
              </Button>
            </CardHeader>
